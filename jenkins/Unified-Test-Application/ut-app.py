...
def GetStarted_Ansible_Jenkins_Job():
	...
	global job_path
    	...
    	jjbName= playbook    #  request.form['Jenkins-Job-Name']
    	jjb=job_path         #  request.form['Jenkins-Job-Path']
        #email= 'tgoel@force10networks.com' #request.form['Email'] 
...
def Ansible_test_Job():
    ...
    jjbName= test_type    #  request.form['Jenkins-Job-Name']
    jjb=job_path         #  request.form['Jenkins-Job-Path']
